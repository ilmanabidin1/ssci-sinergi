...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f7f8fb] text-[#14213d]">
      <header className="relative z-10 border-b border-[#dfe4ec] bg-[#f7f8fb]/95">
        <nav className="container flex h-[76px] items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#14213d] text-lg font-black text-white">S</span>
        ...
        <section className="relative border-b border-[#dfe4ec] bg-[#14213d] text-white">
          ...
          <div className="container grid gap-14 py-20 md:grid-cols-[1.05fr_.95fr] md:items-center md:py-28">
            <div className="relative z-10">
              <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#efb84b]/40 bg-[#efb84b]/10 px-3 py-1.5 text-xs font-semibold text-[#f6cf78]"><span className="h-1.5 w-1.5 rounded-full bg-[#efb84b]" /> Pilot riset SINERGI 2026</div>
      ...
      <footer className="bg-[#14213d] py-10 text-[#b9c4d8]"><div className="container flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between"><div><div className="flex items-center gap-3 text-white"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#efb84b] font-black text-[#14213d]">S</span><strong>SSCI</strong></div><p className="mt-4 max-w-sm text-xs leading-5">Sustainable Sharia Creditworthiness Index. Sistem pendukung penilaian untuk BPRS.</p></div><div className="text-xs sm:text-right"><p className="font-semibold text-white">Program Hilirisasi Riset SINERGI 2026</p><p className="mt-2">© 2026 SSCI · Universitas Islam Bandung</p></div></div></footer>
    </div>
  );
}
